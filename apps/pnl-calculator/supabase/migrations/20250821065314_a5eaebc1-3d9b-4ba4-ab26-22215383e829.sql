-- Enhanced function to track detailed field-by-field changes (fixed syntax)
  ...
  IF TG_OP = 'UPDATE' THEN
    ...
    ELSE
      ...
      VALUES (
        ...
        COALESCE(array_length(array(SELECT jsonb_object_keys(field_changes)), 1), 0)::text || ' field changes' ||
